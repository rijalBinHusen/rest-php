...
describe("Memverses chapter", async () => {
    ...
    it("Should get chapters", async () => {
        ...
        const response = await fetchReq.doFetch("memverses/chapters/" + idFolderCreated, false, "GET", true)
        const responseJSON = await response.json();
    ...
    it("Failed get chapters because non authenticated", async () => {
        ...
        const response = await fetchReq.doFetch("memverses/chapters/" + idFolderCreated, false, "GET")
        const responseJSON = await response.json();
    ...
    it("Chapter not found", async () => {
        ...
        const response = await fetchReq.doFetch("memverses/chapter/ldldl", false, "GET", true)
        const responseJSON = await response.json();
