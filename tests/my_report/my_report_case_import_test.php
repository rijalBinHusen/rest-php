...
class MyReportCaseImportTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->urlGets = $this->url . 'cases_import';
        $this->urlPost = $this->url . 'case_import/';
    }
    ...
    public function testPostEndpoint()
    {
        ...
        $data = array(
            'bagian' => $faker->firstName('female'),
            'divisi' => $faker->firstName('female'),
            'fokus' => $faker->numberBetween(10000, 1000000),
            'kabag' => $faker->numberBetween(10000, 1000000),
            'karu' => $faker->firstName('female'),
            'keterangan1' => $faker->firstName('female'),
    ...
    public function testPostEndpointFailed()
    {
        ...
        $this->assertEquals('Failed to add case import, check the data you sent', $convertToAssocArray['message']);
    }
    ...
    public function testGetEndpoint()
    {
        ...
        $this->assertArrayHasKey('bagian', $convertToAssocArray['data'][0]);
        $this->assertArrayHasKey('divisi', $convertToAssocArray['data'][0]);
        $this->assertArrayHasKey('fokus', $convertToAssocArray['data'][0]);
        $this->assertArrayHasKey('kabag', $convertToAssocArray['data'][0]);
        $this->assertArrayHasKey('karu', $convertToAssocArray['data'][0]);
        $this->assertArrayHasKey('keterangan1', $convertToAssocArray['data'][0]);
    ...
    public function testPutEndpoint()
    {
        ...
        $this->assertArrayHasKey('message', $convertToAssocArray);
        $this->assertEquals(true, $convertToAssocArray['success']);
        $this->assertEquals("Update case import success", $convertToAssocArray['message']);
    }
    ...
    public function testPutEndpointFailed()
    {
        ...
        $this->assertArrayHasKey('message', $convertToAssocArray);
        $this->assertEquals(false, $convertToAssocArray['success']);
        $this->assertEquals('Failed to update case import, check the data you sent', $convertToAssocArray['message']);
    }
