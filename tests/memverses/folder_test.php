...
class folder_test extends TestCase
{
    ...
    public function testGetEndpoint()
    {
        ...
        $this->assertArrayHasKey('total_verse_to_show', $convertToAssocArray['data'][0]);
        $this->assertArrayHasKey('show_next_chapter_on_second', $convertToAssocArray['data'][0]);
        $this->assertArrayHasKey('read_target', $convertToAssocArray['data'][0]);
        $this->assertArrayHasKey('is_show_first_letter', $convertToAssocArray['data'][0]);
        $this->assertArrayHasKey('is_show_tafseer', $convertToAssocArray['data'][0]);
        $this->assertArrayHasKey('arabic_size', $convertToAssocArray['data'][0]);
        $this->assertArrayHasKey('changed_by', $convertToAssocArray['data'][0]);
    }
